...
};var getFilterData = function getFilterData(obj) {
...
var addShopCart = function addShopCart() {
    var obj = {
        "stores": 20
    };
    return obj;
};
var delShopCart = function delShopCart() {
    return true;
};
...
var confirmAddr = function confirmAddr() {
    return true;
};
var getAddrList = function getAddrList() {
    var obj = {
        "code": "000000",
        "msg": "操作成功",
        "total": 1,
        ...
        "current_page": 1,
        "last_page": 1,
        "data": [{ "id": "50", "uid": "2", "consignee": "嗯哼", "province": "浙江省", "city": "杭州市", "district": "滨江区", "address": "江陵路2028号)", "building": "", "mobile": "13235864523", "is_default": "0", "lat": "30.2117730", "lng": "120.2153200", "type": "1", "source": "1", "is_delete": "0", "create_time": "2018-04-25 16:07:42", "update_time": "2018-04-25 16:07:42", "pp": null }, { "id": "50", "uid": "2", "consignee": "嗯哼", "province": "浙江省", "city": "杭州市", "district": "滨江区", "address": "江陵路2028号)", "building": "", "mobile": "13235864523", "is_default": "1", "lat": "30.2117730", "lng": "120.2153200", "type": "1", "source": "1", "is_delete": "0", "create_time": "2018-04-25 16:07:42", "update_time": "2018-04-25 16:07:42", "pp": null }, { "id": "50", "uid": "2", "consignee": "嗯哼", "province": "浙江省", "city": "杭州市", "district": "滨江区", "address": "江陵路2028号)", "building": "", "mobile": "13235864523", "is_default": "1", "lat": "30.2117730", "lng": "120.2153200", "type": "1", "source": "1", "is_delete": "0", "create_time": "2018-04-25 16:07:42", "update_time": "2018-04-25 16:07:42", "pp": null }]
    };
    return obj;
};
var deleteAddr = function deleteAddr() {
    return true;
};
// 任务
var getMyTask = function getMyTask() {
    var result = { "code": "200", "msg": "操作成功", "data": [{ "id": 0, "date": "2018-08-06", "note": "(每日一句) The dress doesn't fit her. She is too thin.", "diffDay": 0 }, { "id": 0, "date": "2018-08-06", "note": "小战士，留学之门开启，小纪老师为你加油", "diffDay": 0 }, { "id": 0, "date": "2018-08-06", "note": "了解一下时间规划，可以自己添加任务哦", "diffDay": 0 }] };
    var obj = { data: result };
    return obj;
};
// 获取月数据
var monthData = function monthData() {
    var result = { "code": "200", "msg": "操作成功", "data": [{ "id": "2452", "pid": "2451", "uid": "100000073", "sid": "83", "time_node": "2", "len": "3", "note": "俄文", "is_notice": "1", "child_page": "", "status": "0", "date": "2018-08-02", "year": 2018, "month": "08", "day": "2" }] };
    var obj = { data: result };
